...
#define TERM_CMD_BUF_SIZE		(64)				// Max number of character buffer string command
#define TERM_CMD_LOG_SIZE		(10)				// Max number of loging command
#define TERM_ARGS_BUF_SIZE		(4)				// Max number of arguments in one command
#define TERM_ARG_SIZE			(8)				// Max number character of one arguments
#define CHAR_INTERRUPT			TERM_KEY_ESCAPE 	// Abort execute command key-code symbol
#define STRING_TERM_ENTER		"\r\n"				// String new line
#define STRING_TERM_ARROW		"boot # "				// String arrow enter
...
#define TERM_DEFAULT_ALLOC_EN			(0)			// Default Memory Allocate functions
...
// ************************ Time calculate Settings *************************
	...
	// yout implementation
//extern volatile uint32_t uwTick;							// Variable tackts cntr

#define CLI_GetUs()					(xTaskGetTickCount()*1000*portTICK_PERIOD_MS)	// System time in us
...
#else
#include "cmsis_os.h"
#define cli_malloc		pvPortMalloc// your implementation
#define cli_free		vPortFree// your implementation
#endif
